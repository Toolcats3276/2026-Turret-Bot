...
public class OutFeed extends ParallelCommandGroup {
  ...
  public OutFeed(InfeedSS s_Infeed, FeederSS s_feeder, IndexerSS s_Indexer, RightShooterSS s_RightShooter, LeftShooterSS s_LeftShooter) {
    ...
    addCommands(
      new RepeatCommand(
        new ParallelCommandGroup(
          ...
          new InstantCommand(()-> s_RightShooter.setSpeed(RotationsPerSecond.of(-75))),
          new InstantCommand(()-> s_LeftShooter.setSpeed(RotationsPerSecond.of(-75)))
        )
      )
    );
