...
import static frc.robot.Constants.RobotConstants.FrontLeftTurret.FUEL_EXIT_ANGLE_OFFSET;
import static frc.robot.Constants.RobotConstants.FrontLeftTurret.PITCH_HOME_ANGLE;
import static frc.robot.Constants.RobotConstants.FrontLeftTurret.PITCH_LIMIT_FORWARD;
import static frc.robot.Constants.RobotConstants.FrontLeftTurret.PITCH_LIMIT_REVERSE;
...
public class LeftShooterHoodSS extends SubsystemBase{
    ...
    private TalonFX m_HoodMotor = new TalonFX(RobotConstants.FrontLeftTurret.Hood_Rotation_Motor, CTREConfigs.CanivoreCANbus);
    private CANcoder e_HoodEncoder = new CANcoder(RobotConstants.FrontLeftTurret.Hood_Encoder, CTREConfigs.CanivoreCANbus);
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Left Hood Angle", getPitch().in(Degrees));
        SmartDashboard.putNumber("Left Hood Rotations", getPitch().in(Rotations));
        SmartDashboard.putNumber("Left Hood Velocity", m_HoodMotor.getVelocity().getValueAsDouble());
